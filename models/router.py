...
class Router(ABC):
    ...
    @abstractmethod
    def route(self, train: TrainInterface, current_time: datetime) -> Task:
        pass
...
class RandomRouter(Router):
    ...
    def route(self, train: TrainInterface, current_time):
        ...
        task = self.choose_task(current_time, train_size=train.capacity)
    ...
    def choose_task(self, current_time, train_size) -> Task:
